# ==============================================================================
# SERVER MODULE: EXPLORATION TAB
# ==============================================================================
# PURPOSE: Handle reactive data filtering, map rendering, trend generation
# FEATURES: Auto-updating filters, auto-zoom to state, 7 trend visualizations
# KEY REACTIVES:
#   - filtered_data(): Auto-updates based on filter selections
#   - Auto-zoom observe() watches state_filter for map zooming
