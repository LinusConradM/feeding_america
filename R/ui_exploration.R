# ==============================================================================
# UI MODULE: EXPLORATION TAB
# ==============================================================================
# PURPOSE: Interactive maps, trends, and data exploration
# FEATURES: Auto-updating map (no button needed!), trend analysis, data tables
  ...
  fluidPage(
    sidebarLayout(
      ...
      sidebarPanel(
        ...
        # Auto-Update Notice
        # ----------------------------------------------------------------
        # Map updates automatically when filters change (no button needed)
