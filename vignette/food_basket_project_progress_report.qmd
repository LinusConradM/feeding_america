...
1.  **National trends**—13.5% U.S. food insecurity in 2023 [@usda_ers_2024]
2.  **Geographic disparities**—rural/southern counties show highest rates [@feeding_america_2024]
3.  **Socioeconomic determinants**—strong links to income, race, family structure [@gundersen_ziliak_2015]
4.  **Policy interventions**—SNAP reduces food insecurity \~6% [@gundersen_kreider_pepper_2017].
...
| **Data Source** | Feeding America (2009-2023 [@feeding_america_2024] | USDA Atlas (2019) |
...
![Tab 3](images/AnalysisRegression-2.png)
...
-   **User Controls:** Geographic filters (state/county), temporal sliders (2009-2023), variable selection (socioeconomic indicators), demographic focus (rural/urban, race/ethnicity). Dynamic UI switches between state/county analysis.
    ...
    ![User Controls](images/UserDataOptions_PlaceHolder-2.png)
